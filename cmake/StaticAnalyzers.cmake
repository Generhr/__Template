...
macro(enable_clang_tidy)
    ...
    if(CLANG_TIDY_EXE)
        ...
        if(CLANG_TIDY_CACHE_EXE)
            set(CLANG_TIDY_COMMAND "${CLANG_TIDY_CACHE_EXE}" -p=${CMAKE_BINARY_DIR} ${CLANG_TIDY_QUIET_ARG} ${CLANG_TIDY_EXTRA_ARGS} ${CLANG_TIDY_ERRORS_ARG})
        else() #~ https://clang.llvm.org/extra/clang-tidy/
            set(CLANG_TIDY_COMMAND "${CLANG_TIDY_EXE}" -p=${CMAKE_BINARY_DIR} ${CLANG_TIDY_QUIET_ARG} ${CLANG_TIDY_EXTRA_ARGS} ${CLANG_TIDY_ERRORS_ARG})
        endif()
